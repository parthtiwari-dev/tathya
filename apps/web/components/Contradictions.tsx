  ...
  return (
    <section aria-labelledby="contradictions-heading">
      ...
      <p className="mt-1 text-xs text-ink-muted">
        The same entity, at two different points — shown side by side, no verdict on which is right.
      </p>
  ...
  return (
    <div className="rounded-md bg-surface p-3">
      ...
      <a
        ...
        className="mt-2 inline-block text-xs text-ink-muted hover:text-accent hover:underline"
      >
