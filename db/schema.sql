...
create function mark_signal_duplicate(
...
create function upsert_topic_cluster(
  p_title text,
  p_signal_ids uuid[],
...
create function append_topic_event(
  p_topic_id uuid,
  p_event_date date,
  p_description text,
...
create function append_topic_claim(
  p_topic_id uuid,
  p_claim_text text,
...
create function append_topic_fact(
  p_topic_id uuid,
  p_fact_text text,
