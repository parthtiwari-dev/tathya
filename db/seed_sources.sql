...
insert into sources (source_key, name, type, url, trust_category, enabled) values
  ...
  ('rbi-press-releases', 'Reserve Bank of India - Press Releases', 'rss', 'https://www.rbi.org.in/pressreleases_rss.xml', 'official', true),
  ...
  ('unfiltered-by-samdish-youtube', 'UNFILTERED by Samdish - YouTube', 'youtube', 'https://www.youtube.com/feeds/videos.xml?channel_id=UCOtQWL2z-tFbI-mgy_Rpdgg', 'media', true),
  ('sunday-show-sarthak-youtube', 'The Sunday Show (Sarthak Goswami) - YouTube', 'youtube', 'https://www.youtube.com/feeds/videos.xml?channel_id=UC5fcjujOsqD-126Chn_BAuA', 'media', true),
  ('think-school-youtube', 'Think School - YouTube', 'youtube', 'https://www.youtube.com/feeds/videos.xml?channel_id=UCKZozRVHRYsYHGEyNKuhhdA', 'media', true),
