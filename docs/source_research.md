...
| Income Tax Department press releases | Official | `https://www.incometaxindia.gov.in/press-release-rss-feed/-/asset_publisher/bxhj/rss` | Registered - blocked | Official Ministry of Finance department feed is documented, but live audit returned HTTP 403. |
| RBI press releases | Official regulator | `https://www.rbi.org.in/pressreleases_rss.xml` | Enabled | Live audit fetched 10 rich official records with good canonical URLs and 1.5k-10k text length. Useful primary/regulatory signal, but not a Union Government ministry source. |
